          ...
          <div className="relative hidden overflow-hidden border-r bg-muted/40 p-12 lg:flex lg:flex-col lg:justify-between">
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground">
                Your AI-powered operating system for shipping software
            ...
            <div className="space-y-5">
              ...
              <Feature
                icon={<FolderKanban />}
                text="Manage projects across your organization"
              />

              <Feature
                icon={<Sparkles />}
                text="Generate AI-powered PRDs in seconds"
              />
          ...
          <div className="flex flex-col justify-center p-10 sm:p-14">
            ...
            <div className="mb-10">
              ...
              <p className="mt-3 text-muted-foreground">
                Every project, repository, feature request, PRD, and task
